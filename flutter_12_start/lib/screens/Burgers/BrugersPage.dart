              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return CatgoryTile(categories[index].name!);
                  },
                ),
              ),
              const SizedBox(height: 20),
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return FoodTile(
                              ...
                              fries[index].name!,
                              fries[index].price!,
                              fries[index].description!,
                              fries[index].ingredients!,
                            );
                          },
                        ),
                      ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text('4.5', style: UiHelper.blackTextFeildStyle()),
                          ],
                        ),
                      ],
                    ),
