...
class _YourorderState extends State<YourorderPage> {
  ...
  TextEditingController TextController = TextEditingController();
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Your Order' , style: TextStyle(color: Color(0xFF333333), fontSize: 18, fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
          ...
          child: Padding(
            ...
            child: Column(children: [
              Container(
                ...
                child: Row(children: [
                  Padding(
                    ...
                    child: UiHelper.CustomRadiusImage(imagePath: 'Crispy Chicken.png', width: 95.74, height: 150.06, topLeft: 10, topRight: 10, bottomLeft: 10, bottomRight: 10, fit: BoxFit.cover ),
                  ),
                  Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 4),
                                Text('4.7', style: UiHelper.blackTextFeildStyle()),
                              ],
                            ),
                                          ],
                        ),
                      ...
                      SizedBox(height: 5,),
                    Text('Lettuce, tomatoes and secret sauce', style:UiHelper.ShortTextFeildStyle(),),
                      SizedBox(height: 5,),
                      Container(
                        width: 220,
                        child: Row(
                          ...
                          children: [
                            Row(children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: Colors.black
                                            .withOpacity(0.2), // shadow ka color aur opacity
                                ...
                                }, icon: Icon(Icons.remove, color: Colors.white, size: 20,), padding: EdgeInsets.all(0)),
                              ),Container(
                                width: 38,
                                height: 24,
                                decoration: BoxDecoration(
                              ...
                              Container(
                                ...
                                }, icon: Icon(Icons.add, color: Colors.white, size: 20,), padding: EdgeInsets.all(0)),
                              ),
                            ],),
                            Text('\$${totalPrice.toStringAsFixed(2)}', style:UiHelper.blueTextFeildStyle()),
                          ],
                        ),
                      )
                  ],)
                   ...
                   child: Column(
                     children: [
                       Row(
                         mainAxisAlignment: MainAxisAlignment.spaceBetween,
                         children: [
                        Text('Subtotal', style: UiHelper.ShortTextFeildStyle(),),
                        Text('\$${totalPrice.toStringAsFixed(2)}', style: UiHelper.ShortTextFeildStyle(),),
                                   ],),
              SizedBox(height: 10,),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                Text('Delivery', style: UiHelper.ShortTextFeildStyle(),),
              ...
              Row(
                ...
                Text('\$${totalPrice.toStringAsFixed(2)}', style: UiHelper.blackTextFeildStyle(),),
              ],),
                     ],
                   ),
                 ),
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                          Text('Total Earning', style: UiHelper.witeTextFeildStyle()),
                          Row(
                            children: [
                              UiHelper.CustomImage(imagePath: 'Coin_icon.png'),
                              Text('25 Coins', style: UiHelper.boldWiteTextFeildStyle(),),
                            ],
                          ),
                        ],),
                      ),
              ...
              Align(
                alignment: Alignment.centerLeft,
                  child: Text('Payment method' ,style: UiHelper.boldBlackTextFeildStyle(),)),
              SizedBox(height: 5,),
              Align(
                alignment: Alignment.centerLeft,
                  child: Text('All transactions are secure and encrypted.', style: UiHelper.ShortTextFeildStyle(),)),
              SizedBox(height: 10,),
              Container(
                width: MediaQuery.of(context).size.width,
                child: Row(
              ...
              Align(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Address', style: UiHelper.boldBlackTextFeildStyle(),),
                    SizedBox(width: 10,),
                  ...
                  child: Row(children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                        Text('My home' , style: UiHelper.boldBlackTextFeildStyle(),),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Alex Johnson,',  style: UiHelper.ShortTextFeildStyle(),
                            ),
                            Text('123 Main Street, Apt 48, New York',  style: UiHelper.ShortTextFeildStyle(),
                            ),
                            Text('United States : +1 (555) 123-4567',
                ...
                child: Column(children: [
                  ...
                  child: TextField(
                    ...
                    Container(
                      ...
                      child: Center(child: Text('Apply', style: UiHelper.witeTextFeildStyle(),)),
                    )
                  ],)
                ],),
              ),
