      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: Image.asset(widget.image, height: MediaQuery
                .of(context)
                .size
                .height / 3, fit: BoxFit.contain,)),
            ...
            Padding(
              ...
              child: Text(
                'Lorem ipsum dolor sit amet consectetur elit. enim omnis magnam, doloremque voluptate dolore.',
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    setState(() {
                      quantity++;
                      int basePrice = int.parse(widget.price.replaceAll(RegExp(
                          r'[^\d]'), ''));
                ...
                GestureDetector(
                  ...
                  child: Material(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        Icons.remove, color: Colors.white, size: 30.0,),
                    ),
                  ),
                ),
              ],
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: GestureDetector(
                        onTap: () async {
                          if (address == null || address!.isEmpty) {
                            ...
                            Map<String, dynamic> userOderMap = {
                              ...
                              'orderId': oderId,
                              'status': 'pending',
                              'address': address == null ? addressController
                                  .text : address,
                            };
                            await DatabaseMethods().addUserOrderDetails(
                                userOderMap, id!, oderId);
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                ...
                                content: Text('Add some money to your wallet',
                                  style: TextStyle(fontSize: 18.0,
                                      color: Color.fromARGB(255, 0, 0, 0)),)
                            ));
                          }
                        ...
                        child: Text(
                          'Order Now', style: AppWidget.whiteTextFeildStyle(),
                        ),
                      ),
                    ),
                  ),
  ...
  displayPaymentSheet(String amount) async {
    try {
      await Stripe.instance.presentPaymentSheet().then((value) async {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            backgroundColor: Colors.greenAccent,
            content: Text(' Order Placed Successfully', style: TextStyle(
